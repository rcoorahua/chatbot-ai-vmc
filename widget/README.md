...
| **Carga del hilo** | hilo vacío mientras el saludo "llega" (~420 ms) o el primer sondeo no volvió | Un **spinner** común de 26 px centrado (aro vault con el cuarto vivo en magenta *live*); luego el saludo lo reemplaza. Se probaron un skeleton y el orbe líquido y se descartaron: el orbe es el estado "Subastín está pensando" y aquí solo se lee el estado |
