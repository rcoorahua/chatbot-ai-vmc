...
| C32 | *(pestaña nueva)* abrir el chat por primera vez | Durante la fracción de segundo antes del "¡Hola! 👋" se ve el **orbe líquido centrado** en el hilo (más grande que el de "escribiendo"), no un hilo vacío; el saludo lo reemplaza. Como autenticado con historial, el skeleton dura hasta que llegan los mensajes. El orbe de "escribiendo" y los puntos de respaldo van en **vault + magenta/rosa "live"** |
