...
/** `FORM_RESPONSE` (D-029): lo que el usuario contestó en el formulario de asesor. */
export type MessageType = "TEXT" | "IMAGE" | "SYSTEM" | "FORM_RESPONSE";
...
export interface Conversation {
  ...
  /** Hoy solo `user_form` (D-029: el caso nace del formulario); `format.handoffReasonLabel` lo traduce. */
