  ...
  function liquidOrbGl(size) {
    ...
    if (!orbShared) {
      ...
      const fragmento =
        ...
        // Paleta Concorde (2026-09-03, Aaron; rebalanceada el mismo dia porque el magenta se
        // comia el vault): base vault-900, banda ancha vault-500, acento magenta y rim rosa
        // "live" de VMC (#cc00ff / #ff0066, los del alert card). Igual que el orbe WebGPU.
        "vec3 fondo=vec3(.13,0.,.36);" +
        "vec3 magenta=vec3(.518,.376,.898);" +
        "vec3 rosa=vec3(.8,0.,1.);" +
