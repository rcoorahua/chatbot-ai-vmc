...
| **Formulario de asesor** | `metadata.interaction.type = "HANDOFF_FORM"` (del bot) o el badge | Al ancho de una burbuja, del lado del bot. Cabecera con **1/2** (no "Paso 1 de 2") y una **x**; asterisco en los obligatorios; Siguiente/Enviar apagados hasta llenarlos. Entra con un fade desde arriba mientras **el compositor se retira hacia abajo**; la x lo cierra suave y el compositor vuelve subiendo. Lo escrito se conserva en `formDraft` |
