...
| Quién | Qué obtiene |
|---|---|
| **Usuario anónimo** | Abre el chat sin login ni datos; FAQ y catálogo automáticos, y su conversación dura lo que la pestaña. Lo atiende solo el bot: para hablar con un asesor tiene que iniciar sesión en VMC (D-002/D-031), el bot se lo dice y le da el botón |
