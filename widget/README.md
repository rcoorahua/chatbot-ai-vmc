...
| **Carga del hilo** | hilo vacío mientras el saludo "llega" (~420 ms) o el primer sondeo no volvió | El **orbe líquido** centrado en el hilo, más grande que el de "escribiendo" (84 px), como el círculo de carga de Intercom pero con la animación propia; luego el saludo lo reemplaza. Se probó un skeleton y se descartó (decisión de Aaron). Sin WebGL, los tres puntos |
